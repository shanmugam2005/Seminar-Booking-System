...
<%
    ...
    try {
       ...
       PreparedStatement stmt = conn.prepareStatement("SELECT Time_Slots FROM ece WHERE Hall_Type =? and booking_date=? and lab=? "); 
// Prepare SQL query
        ...
        stmt = conn.prepareStatement("SELECT Time_Slots FROM ece WHERE Hall_Type =? and booking_date=? and lab=?"); 
// Prepare SQL query
        stmt.setString(1,"lab");
        stmt.setString(2,todayDate);
        stmt.setString(3,"RM");
...
// Prepare SQL query
        ...
        stmt = conn.prepareStatement("SELECT Time_Slots FROM ece WHERE Hall_Type =? and booking_date=?"); 
// Prepare SQL query
...
// Prepare SQL query
       ...
       stmt = conn.prepareStatement("SELECT Time_Slots FROM ece WHERE Hall_Type =? and booking_date=?and room=?"); 
// Prepare SQL query
        ...
        <div class="container">
            ...
            <div class="hall-grid">
                ...
                <div class="hall">
                    ...
                    <form action="submitBookingEce.jsp" method="post">
...
<button class="view-booked-dates-button" onclick="window.location.href='getBookedDatesEce.jsp?type=conference'">Show/Hide Booked Dates</button>
...
<button class="view-booked-dates-button" onclick="window.location.href='getBookedDatesEce.jsp?type=seminar'">Show/Hide Booked Dates</button>
                ...
                <div class="hall">
                    ...
                    <form action="submitBookingEce.jsp" method="post">
                        ...
                        <select id="lecture-room" onChange="updateTimeSlots(bookingDate.value,this.value)" name="room" >
                            <option value="F9">H21</option>
                            <option value="F12">H22</option>
                            <option value="F14">H23</option>
                            <option value="F15">H24</option>
...
<button class="view-booked-dates-button" onclick="window.location.href='getBookedDatesEce.jsp?type=lecture'">Show/Hide Booked Dates</button>
                ...
                <div class="hall">
                    ...
                    <form action="submitBookingEce.jsp" method="post">
                        ...
                        <select id="lab-room" onChange="updateTimeSlots(bookingDate.value,this.value)" name="lab">
                            <option value="ICL">VLSI Lab</option>
                            <option value="RM" >Embedded Lab</option>
                            <option value="CISCO">Network Lab</option>
                            <option value="APJ">PCB Design Lab</option>
                        </select><br><br>
...
<button class="view-booked-dates-button" onclick="window.location.href='getBookedDatesEce.jsp?type=lab'">Show/Hide Booked Dates</button>
                    <div id="lab-booked-dates" class="booked-dates hidden"></div>
                </div>

            </div>
      <button type="button" class="view-booked-dates-button" onclick="window.location.href='cancelBookedDatesEce.jsp'">Cancel Booking</button>
