...
<%
    ...
    try {
       ...
       PreparedStatement stmt = conn.prepareStatement("SELECT Time_Slots FROM civil WHERE Hall_Type =? and booking_date=? and lab=? "); 
// Prepare SQL query
        ...
        stmt = conn.prepareStatement("SELECT Time_Slots FROM civil WHERE Hall_Type =? and booking_date=? and lab=?"); 
// Prepare SQL query
        stmt.setString(1,"lab");
        stmt.setString(2,todayDate);
        stmt.setString(3,"RM");
...
// Prepare SQL query
        ...
        stmt = conn.prepareStatement("SELECT Time_Slots FROM civil WHERE Hall_Type =? and booking_date=?"); 
// Prepare SQL query
...
// Prepare SQL query
       ...
       stmt = conn.prepareStatement("SELECT Time_Slots FROM civil WHERE Hall_Type =? and booking_date=?and room=?"); 
// Prepare SQL query
        ...
        <div class="container">
            ...
            <div class="hall-grid">
                ...
                <div class="hall">
                    ...
                    <form action="submitBookingCivil.jsp" method="post">
...
<button class="view-booked-dates-button" onclick="window.location.href='getBookedDatesCivil.jsp?type=conference'">Show/Hide Booked Dates</button>
...
<button class="view-booked-dates-button" onclick="window.location.href='getBookedDatesCivil.jsp?type=seminar'">Show/Hide Booked Dates</button>
                ...
                <div class="hall">
                    ...
                    <form action="submitBookingCivil.jsp" method="post">
                        ...
                        <select id="lecture-room" onChange="updateTimeSlots(bookingDate.value,this.value)" name="room" >
                            <option value="F9">H1</option>
                            <option value="F12">H2</option>
                            <option value="F14">H3</option>
                            <option value="F15">H4</option>
...
<button class="view-booked-dates-button" onclick="window.location.href='getBookedDatesCivil.jsp?type=lecture'">Show/Hide Booked Dates</button>
                ...
                <div class="hall">
                    ...
                    <form action="submitBookingCivil.jsp" method="post">
                        ...
                        <select id="lab-room" onChange="updateTimeSlots(bookingDate.value,this.value)" name="lab">
                            <option value="ICL">Survey Lab</option>
                            <option value="RM" >Concrete Lab</option>
                            <option value="CISCO">Soil Lab</option>
                            <option value="APJ">Autocad Lab</option>
                        </select><br><br>
...
<button class="view-booked-dates-button" onclick="window.location.href='getBookedDatesCivil.jsp?type=lab'">Show/Hide Booked Dates</button>
                    <div id="lab-booked-dates" class="booked-dates hidden"></div>
                </div>

            </div>
                                           <button type="button" class="view-booked-dates-button" onclick="window.location.href='cancelBookedDatesCivil.jsp'">Cancel Booking</button>
