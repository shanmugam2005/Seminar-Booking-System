...
<%
    ...
    try {
       ...
       PreparedStatement stmt = conn.prepareStatement("SELECT Time_Slots FROM mech WHERE Hall_Type =? and booking_date=? and lab=? "); 
// Prepare SQL query
        ...
        stmt = conn.prepareStatement("SELECT Time_Slots FROM mech WHERE Hall_Type =? and booking_date=? and lab=?"); 
// Prepare SQL query
        stmt.setString(1,"lab");
        stmt.setString(2,todayDate);
        stmt.setString(3,"RM");
...
// Prepare SQL query
        ...
        stmt = conn.prepareStatement("SELECT Time_Slots FROM mech WHERE Hall_Type =? and booking_date=?"); 
// Prepare SQL query
...
// Prepare SQL query
       ...
       stmt = conn.prepareStatement("SELECT Time_Slots FROM mech WHERE Hall_Type =? and booking_date=?and room=?"); 
// Prepare SQL query
        ...
        <div class="container">
            ...
            <div class="hall-grid">
                ...
                <div class="hall">
                    ...
                    <form action="submitBookingMech.jsp" method="post">
...
<button class="view-booked-dates-button" onclick="window.location.href='getBookedDatesMech.jsp?type=conference'">Show/Hide Booked Dates</button>
...
<button class="view-booked-dates-button" onclick="window.location.href='getBookedDatesMech.jsp?type=seminar'">Show/Hide Booked Dates</button>
...
<button class="view-booked-dates-button" onclick="window.location.href='getBookedDatesMech.jsp?type=lecture'">Show/Hide Booked Dates</button>
                ...
                <div class="hall">
                    ...
                    <form action="submitBookingMech.jsp" method="post">
                        ...
                        <select id="lab-room" onChange="updateTimeSlots(bookingDate.value,this.value)" name="lab">
                            <option value="ICL">Cad Lab</option>
                            <option value="RM" >Advanced computer Lab</option>
                            <option value="CISCO">Meterolgy Lab</option>
                            <option value="APJ">Dynamics Lab</option>
                        </select><br><br>
...
<button class="view-booked-dates-button" onclick="window.location.href='getBookedDatesMech.jsp?type=lab'">Show/Hide Booked Dates</button>
                    <div id="lab-booked-dates" class="booked-dates hidden"></div>
                </div>

            </div>
                         <button type="button" class="view-booked-dates-button" onclick="window.location.href='cancelBookedDatesMech.jsp'">Cancel Booking</button>
