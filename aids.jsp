...
<%
    ...
    try {
       ...
       PreparedStatement stmt = conn.prepareStatement("SELECT Time_Slots FROM aids WHERE Hall_Type =? and booking_date=? and lab=? "); 
// Prepare SQL query
        ...
        stmt = conn.prepareStatement("SELECT Time_Slots FROM aids WHERE Hall_Type =? and booking_date=? and lab=?"); 
// Prepare SQL query
        stmt.setString(1,"lab");
        stmt.setString(2,todayDate);
        stmt.setString(3,"RM");
...
// Prepare SQL query
        ...
        stmt = conn.prepareStatement("SELECT Time_Slots FROM aids WHERE Hall_Type =? and booking_date=?"); 
// Prepare SQL query
...
// Prepare SQL query
       ...
       stmt = conn.prepareStatement("SELECT Time_Slots FROM aids WHERE Hall_Type =? and booking_date=?and room=?"); 
// Prepare SQL query
        ...
        <div class="container">
            ...
            <div class="hall-grid">
                ...
                <div class="hall">
                    ...
                    <form action="submitBookingAids.jsp" method="post">
...
<button class="view-booked-dates-button" onclick="window.location.href='getBookedDatesAids.jsp?type=conference'">Show/Hide Booked Dates</button>
...
<button class="view-booked-dates-button" onclick="window.location.href='getBookedDatesAids.jsp?type=seminar'">Show/Hide Booked Dates</button>
...
<button class="view-booked-dates-button" onclick="window.location.href='getBookedDatesAids.jsp?type=lecture'">Show/Hide Booked Dates</button>
...
<button class="view-booked-dates-button" onclick="window.location.href='getBookedDatesAids.jsp?type=lab'">Show/Hide Booked Dates</button>
                    <div id="lab-booked-dates" class="booked-dates hidden"></div>
                </div>

            </div>
                                           <button type="button" class="view-booked-dates-button" onclick="window.location.href='cancelBookedDatesAids.jsp'">Cancel Booking</button>
